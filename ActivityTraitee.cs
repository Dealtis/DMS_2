...
namespace DMSvStandard
{
	...
	public class ActivityTraitee : Activity
	{	
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView(Resource.Layout.ListeTraitee);
			...
			var table = db.Query<ToDoTask>("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' ORDER BY Ordremission DESC");
			var layout = new LinearLayout(this);


			//GRP
			Appli.nbgroupage = 0;
			var grp = db.Query<ToDoTask> ("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' GROUP BY groupage");
			var i = 0;
			...
			if (Appli.nbgroupage == 0) {
				...
				btngrpUn.Text = "Pas de livraison traitée";
		...
		{	
			...
			var table = db.Query<ToDoTask> ("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[0]+ "' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[0]+"' ORDER BY Ordremission DESC");
			//LISTVIEW
			mListView = FindViewById<ListView> (Resource.Id.listView1);
		...
		void BtngrpDeux_Click (object sender, EventArgs e)
		{
			...
			var table = db.Query<ToDoTask> ("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[1]+"' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[1]+"' ORDER BY Ordremission DESC");
			//LISTVIEW
			mListView = FindViewById<ListView> (Resource.Id.listView1);
		...
		void BtngrpTroisClick (object sender, EventArgs e)
		{
			...
			var table = db.Query<ToDoTask> ("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[2]+"' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[2]+"' ORDER BY Ordremission DESC");
		...
		void BtngrpQuatre_Click (object sender, EventArgs e)
		{
			...
			var table = db.Query<ToDoTask> ("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[3]+"' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[3]+"' ORDER BY Ordremission DESC");
		...
		void BtngrpCinq_Click (object sender, EventArgs e)
		{
			...
			var table = db.Query<ToDoTask> ("SELECT * FROM ToDoTask WHERE StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[4]+"' OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' AND groupage='"+Appli.grp[4]+"' ORDER BY Ordremission DESC");
		...
		{	
			...
			builder.SetNegativeButton("Chercher", delegate {
				...
				var table = db.Query<ToDoTask>("SELECT * FROM ToDoTask WHERE  StatutLivraison = '1' AND typeMission='L' AND typeSegment='LIV' AND (numCommande LIKE '%"+editrecherche.Text+"%' OR  villeLivraison LIKE '%"+editrecherche.Text+"%' OR nomPayeur LIKE '%"+editrecherche.Text+"%'OR CpLivraison LIKE '%"+editrecherche.Text+"%' OR refClient LIKE '%"+editrecherche.Text+"%') OR StatutLivraison = '2' AND typeMission='L' AND typeSegment='LIV' AND (numCommande LIKE '%"+editrecherche.Text+"%' OR  villeLivraison LIKE '%"+editrecherche.Text+"%' OR nomPayeur LIKE '%"+editrecherche.Text+"%'OR CpLivraison LIKE '%"+editrecherche.Text+"%' OR refClient LIKE '%"+editrecherche.Text+"%'OR nomClient LIKE'%"+editrecherche.Text+"%')");
		...
		public void listview(){
			...
			string dbPath = System.IO.Path.Combine (System.Environment.GetFolderPath
				(System.Environment.SpecialFolder.Personal), "ormDMS.db3");
			var db = new SQLiteConnection (dbPath);
			var table = db.Query<ToDoTask>("SELECT * FROM ToDoTask WHERE typeMission='L' AND typeSegment='LIV' AND (numCommande LIKE '%"+App.codebarre+"%' OR  villeLivraison LIKE '%"+App.codebarre+"%' OR nomPayeur LIKE '%"+App.codebarre+"%'OR CpLivraison LIKE '%"+App.codebarre+"%' OR refClient LIKE '%"+App.codebarre+"%') OR typeMission='L' AND typeSegment='LIV' AND (numCommande LIKE '%"+App.codebarre+"%' OR  villeLivraison LIKE '%"+App.codebarre+"%' OR nomPayeur LIKE '%"+App.codebarre+"%'OR CpLivraison LIKE '%"+App.codebarre+"%' OR refClient LIKE '%"+App.codebarre+"%')");
