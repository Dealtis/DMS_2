...
namespace DMSvStandard {
	[Activity(Label = "Signature",Theme = "@android:style/Theme.Black.NoTitleBar.Fullscreen")]
	public class ActivitySignature : Activity {
...
//				signature.SignaturePrompt.SetTextSize (global::Android.Util.ComplexUnitType.Sp, 32f);
				signature.BackgroundColor = Color.Rgb (255, 255, 255); // a light yellow.
				...
				caption.SetPadding (caption.PaddingLeft, 1, caption.PaddingRight, 150);
			}
